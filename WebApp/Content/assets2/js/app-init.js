$(function () {
    ...
    function I() {
        document.addEventListener("DOMContentLoaded", function () {
            ...
            document.getElementById("topnav-hamburger-icon2") && document.getElementById("topnav-hamburger-icon2").addEventListener("click", S);
    ...
    function x() {
        var elm = document.getElementById("vertical-hover");
        if (elm) {
